...
//nevim jak načíst z envu to heslo
const uri =
  "mongodb+srv://wardrobedbuser:ZOn037y347Zh5qQF@cluster0.okmkf.mongodb.net/wardrobe?retryWrites=true&w=majority";
...
async function getMongoCollection() {
  client.connect((err) => {
    const collection = client.db("wardrobe").collection("orders");
