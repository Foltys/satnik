...
export default function PersonOnOrder({ id, translator, details }: PersonOnOrderParams) {
	return (
		<Form method="post" action="/formular/newOrder">
			...
			<div className="flex rounded-2xl group bg-red text-light w-full h-72 p-2 border border-red mb-6">
				...
				<div className=" flex flex-col justify-center mx-4">
					<span className="text-2xl font-bold">{decodeURIComponent(details.fullname)}</span>

					<span className="py-2">{decodeURIComponent(details.requirements)}</span>
